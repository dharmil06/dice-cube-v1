...
function Die(props) {
  return(<div>  {
    (() => {
      if (props.face === 1) {
        return (         
            <svg xmlns="http://www.w3.org/2000/svg" width="160" height="160" fill="currentColor" className="bi bi-dice-1-fill" viewBox="0 0 16 16">
      ...
      } else if (props.face === 2) {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width="160" height="160" fill="currentColor" className="bi bi-dice-2-fill" viewBox="0 0 16 16">
      ...
      } else if (props.face === 3) {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width="160" height="160" fill="currentColor" className="bi bi-dice-3-fill" viewBox="0 0 16 16">
      ...
      } else if (props.face === 4) {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width="160" height="160" fill="currentColor" className="bi bi-dice-4-fill" viewBox="0 0 16 16">
      ...
      } else if (props.face === 5) {
        return (        
            <svg xmlns="http://www.w3.org/2000/svg" width="160" height="160" fill="currentColor" className="bi bi-dice-5-fill" viewBox="0 0 16 16">
      ...
      }else if (props.face === 6) {
        return (        
          <svg xmlns="http://www.w3.org/2000/svg" width="160px" height="160px" fill="currentColor" className="bi bi-dice-6-fill" viewBox="0 0 16 16">
